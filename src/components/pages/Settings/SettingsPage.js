  ...
  return (
    <div className="settings-page">
      <div className="settings-form">
        ...
        />
        <button className="change-password-btn" onClick={handleChangePassword}>Changer le mot de passe</button>
        ...
        {confirmDelete ? (
          <>
            ...
            />
            <button className="delete-account-btn" onClick={handleDeleteAccount}>Confirmer la suppression</button>
          </>
        ) : (
          <button className="delete-account-btn" onClick={() => setConfirmDelete(true)}>Supprimer le compte</button>
        )}
      </div>
    </div>
  );
